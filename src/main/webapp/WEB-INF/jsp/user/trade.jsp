						...
						<table class="table mytable">
							...
							<tr>
								<td colspan="5">
									<nav>
										<ul class="pagination">
											<li><a href='user/trade/0'>首页</a></li>
											<c:if test="${page.number > 0}">
												<li><a href='user/trade/${page.number - 1}'>&laquo;上一页</a>
												</li>
											</c:if>
											...
											<c:if test="${page.number < page.totalPages - 1}">
												<li><a href='user/trade/${page.number + 1}'>下一页&raquo;</a>
												</li>
											</c:if>
											<c:if test="${page.number >= page.totalPages - 1}">
												<li class="disabled"><a>下一页&raquo;</a></li>
											</c:if>
											<li><a href='user/trade/${page.totalPages - 1}'>末页</a></li>
										</ul>
									</nav>
								</td>
							</tr>
